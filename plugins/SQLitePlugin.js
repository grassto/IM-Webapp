(function () {
    ...
    SQLitePlugin.prototype.open = function (success, error) {
        ...
        if (this.dbname in this.openDBs) {
            ...
            step2 = (function (_this) {
                return function () {
                    sqlite.open([_this.openargs], opensuccesscb, openerrorcb);
                    //cordova.exec(opensuccesscb, openerrorcb, "SQLitePlugin", "open", [_this.openargs]);
                };
            })(this);
            sqlite.close(this.dbname, step2, step2);
    ...
    SQLitePlugin.prototype.close = function (success, error) {
        if (this.dbname in this.openDBs) {
            ...
            //    }
            //]);
            sqlite.close(this.dbname, success, error);
        } else {
    ...
    SQLiteFactory = {
        ...
        deleteDatabase: function (first, success, error) {
            ...
            return sqlite.delete([args], success, error);

Ext.define("Ext.package.Entry", {
    ...
    constructor: function (name) {
        ...
        me.packageName = name;
        var profile = Ext.isEmpty(Ext.manifest.profile) ? '' : Ext.manifest.profile + '/';
        me.jsUrl = profile + Ext.getResourcePath(name + '.js', null, name);
        me.cssUrl = profile + Ext.getResourcePath(name + '.css', null, name);
